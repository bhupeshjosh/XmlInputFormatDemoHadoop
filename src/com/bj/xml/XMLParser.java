...
public class XMLParser
{
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException
	{
		...
		conf.set("xmlstarttag", "<property>");
		conf.set("xmlendtag", "</property>");
		...
		job.setInputFormatClass(CustomInputFormat.class);					//set Input Format
		job.setOutputKeyClass(NullWritable.class);
		job.setOutputValueClass(Text.class);

		org.apache.hadoop.filecache.DistributedCache.addFileToClassPath(new Path("/jdom-2.0.6/jdom-2.0.6.jar"), job.getConfiguration(), FileSystem.get(conf));
